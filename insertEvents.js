...
// MongoDB connection - Auto switches between MongoDB & Demo Mode
...
mongoose.connect(mongoUri, { 
  ...
  .catch((err) => {
    console.log('⚠️  Using Demo Mode - MongoDB not available');
    console.log('   To connect MongoDB: Install locally or use MongoDB Atlas');
  });
